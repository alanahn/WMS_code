...
public class Exam01to10 {
    ...
    /*
     * 문제3. 다음 중 배열을 선언하거나 초기화한 것 중 틀린 것을 고르세요.
     * 1) int arr[3];
     * 2) int[] arr = {1,2,3,4};
    ...
    private static void Exam05() {
        System.out.println("[문제5]: " + "4"); //O
    }

    /*
     * 문제6. 다음 중 메소드의 올바른 선언이 아닌 것을 고르세요.
     * 1) public void myMethod() {}
     * 2) void myMethod() { return 0; }
     * 3) protected boolean myMethod() { return true; }
     * 4) private int myMethod(int a, int b) { return a + b; }
     */
    private static void Exam06() {
        System.out.println("[문제6]: " + "3"); //X 2
    }

    /*
     * 문제7. 다음 중 조건문에 대한 설명으로 틀린 것을 고르세요.
     * 1) 조건문은 반복문 안에서 사용할 수 없다.
     * 2) switch 문은 변수의 값에 따라 실행할 코드를 선택한다.
     * 3) if-else 문은 조건에 따라 두 가지 경우 중 하나를 실행한다.
     * 4) 삼항 연산자는 조건문을 간단하게 표현할 때 사용된다.
     */
    private static void Exam07() {
        System.out.println("[문제7]: " + "1"); //O
    }

    /*
     * 문제8. 다음 중 올바른 클래스 선언을 고르세요.
     * 1) void class MyClass {}
     * 2) public class MyClass {}
     * 3) private class MyClass {}
     * 4) protected class MyClass {}
     */
    private static void Exam08() {
        System.out.println("[문제8]: " + "2"); //O
    }

    /*
     * 문제9. 다음 중 생성자에 대한 설명으로 틀린 것을 고르세요.
     * 1) 생성자는 반환 타입이 없다.
     * 2) 생성자는 여러 개 정의할 수 없다.
     * 3) 생성자는 클래스와 이름이 동일하다.
     * 4) 생성자는 객체 생성 시 자동으로 호출된다.
     */
    private static void Exam09() {
        System.out.println("[문제9]: " + "1"); //X 2
    }

    /*
     * 문제10. 다음 중 객체에 대한 설명으로 틀린 것을 고르세요.
     * 1) 객체는 클래스의 인스턴스이다.
     * 2) 객체는 상태와 행위를 가진다.
