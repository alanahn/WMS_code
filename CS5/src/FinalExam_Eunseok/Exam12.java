...
public class Exam12 {
    public static void main(String[] args) {
        System.out.println("----");
        // 캐릭터 생성
        GameCharacter GameSetting = new GameCharacter("은석", 1, 5, 1);
        System.out.println("캐릭터 생성 및 초기 정보 출력");
        // 초기 정보 출력
        GameSetting.printInfo();
        System.out.println("-------");
...
class GameCharacter {
    ...
    // calculateDefensePower 메소드
    public int calculateDefensePower() {
        this.defensePower = this.level * 2;
        return defensePower;
    }
    ...
    public void levelUp() {
        ...
        int new_attack = calculateAttackPower();
        int new_defense = calculateDefensePower();
        System.out.println("경험치를 획득하여 레벨이 " + this.level + "가 되었습니다!");
        System.out.println("새로운 공격력: " + new_attack);
        System.out.println("새로운 방어력: " + new_defense);
    }
}
