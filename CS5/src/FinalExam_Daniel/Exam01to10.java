...
public class Exam01to10 {
    ...
    /*
     * 문제9. 다음 중 조건문에 대한 설명으로 틀린 것을 고르세요.
     ...
     * 1) 객체는 상태와 행위를 가진다.
     * 2) 객체는 클래스의 인스턴스이다.
     * 3) 객체는 new 키워드를 사용하여 생성한다.
     * 4) 하나의 클래스는 여러 개의 객체를 생성할 수 없다.
     */
    private static void Exam10() {
        System.out.println("[문제10]: " + "4"); //O
    }
