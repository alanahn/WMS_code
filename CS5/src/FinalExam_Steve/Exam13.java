...
/**
 * [15점]문제13. 간단한 게임 캐릭터 클래스를 활용하여 게임의 진행을 시뮬레이션하는 프로그램을 작성하세요.
 * 
 ...
 * 
 * 게임 진행 코드는 Exam13 클래스에 작성하며, 다음과 같은 실행 결과를 출력해야 합니다:
 * 
 * [실행 결과 예시]
 * -------
 * 캐릭터 생성 및 초기 정보 출력
...
public class Exam13 {
    public static void main(String[] args) {
        // 캐릭터 생성
        GameCharacter gameCharacter = new GameCharacter("스티브", 1);
...
private int defensePower;
    ...
    private int calculateAttackPower(int attackPower){
    ...
    // calculateAttackPower 메소드
    private int calculateDefensePower(int defensePower){
    ...
    public void levelUp(){
        ...
        defensePower = calculateDefensePower(defensePower);
        System.out.println("-------");
